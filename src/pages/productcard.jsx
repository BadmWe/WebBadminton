...
const product = {
  name: 'Astrox 100ZZ (Dark Navy)',
  href: '#',
  price: '$220',
  description:
    'Extra-flex powerful badminton racket Yonex Astrox 100 ZZ!The most powerful and powerful badminton racket from Yonex. The racquets use a new hyper-thin Namd core shank to deliver high power and speed while flexing, and reduce air resistance for maximum hitting speed.The world badminton leaders Viktor Axelsen, Akane Yamaguchi and Chou Tien Chen became the ambassadors of the new badminton racket Yonex Astrox 100 ZZ',
  imageSrc:
              ...
              <section aria-labelledby="options-heading">
                ...
                <form>
                  ...
                  <div className="mt-6 text-center">
                    ...
                    >
                      <ShieldCheckIcon className="" aria-hidden="true" />
