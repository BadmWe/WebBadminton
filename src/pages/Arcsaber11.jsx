  ...
  images: [
    {
      id: 1,
      name: 'View',
      src: 'https://badm-store.ru/image/cache/catalog/products/raketki/yonex/Arcsaber-11-600x600.jpg',
      alt: '',
    },
    {
      id: 2,
      name: 'Case',
      src: 'https://badm-store.ru/image/cache/catalog/products/raketki/chexly/Cover-Yonex-Arcsaber-1100x1100.jpg',
      alt: '',
    },
  ],
  colors: [],
  ...
  details: [
    {
      ...
      items: [
        ...
        'Balance: Even',
        'Grip: G4',
        'Material: H.M. Graphite, CS Carbon Nanotube, Super HMG, Sonic Metal',
...
const footerNavigation = {
  products: [{ name: 'Rackets', href: '#' }],
  company: [
    { name: 'Who we are', href: '#' },
    { name: 'Blog', href: '#' },
    { name: 'For begginers', href: '#' },
  ],
  customerService: [
    { name: 'Contact', href: '#' },
    { name: 'Shipping', href: '#' },
                      ...
                      >
                        <div className="space-y-4">
                          {category.featured.map((item, itemIdx) => (
                            <div
                              key={itemIdx}
                              className="aspect-w-1 aspect-h-1 group relative overflow-hidden rounded-md bg-gray-100"
                            >
                              <img
                                src={item.imageSrc}
                                alt={item.imageAlt}
          ...
          <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
            ...
            <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
              ...
              <form className="mt-6">
                {/* Colors */}
                <div>
                  <h3 className="text-sm text-gray-600">Color: Metallic Red</h3>
