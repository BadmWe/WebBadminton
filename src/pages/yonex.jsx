  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:image" content="/photos/yonexlog.jpg" />
            ...
            <div className="mt-8 lg:mt-0">
              <div className="mx-auto max-w-prose text-base lg:max-w-none">
                ...
                <div className="prose prose-indigo mx-auto mt-5 text-gray-500 lg:col-start-1 lg:row-start-1 lg:max-w-none">
                  <p>
                    The company was later forced out of this market because of
                    the invention of plastic floats. This led to a commitment by
                  ...
                  <p>
                    ...
                    introduced, and within another two years an export company
                    was created for the worldwide distribution. After the
                    company began to make aluminium badminton racquets in 1969,
                    it found that the same technology could be applied to the
                    tennis racket which the company introduced in 1971. The
                    company began to experiment with graphite shafts for both
                    types of rackets and found that these would also be useful
                    for golf clubs.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    &quot;sweet &quot;spot&quot; to hit the shuttle. It led
                    other manufacturers to follow suit in
                  ...
                  <p>
                    ...
                    national badminton associations around the world, such as
                    the Malaysian Badminton Association, Badminton Scotland,
                    Badminton England, Badminton Ireland, and Badminton Wales.
                    Yonex has also been teaming up with OCBC (Orange County
                    Badminton Club) since 2007 to host the annual U.S. Open
                    Grand Prix Badminton Championships.
                  </p>
                  <p>
                    ...
                    competitive players use their racquets, as it is the
                    preferred choice amongst professionals. Yonex is significant
